...
import CustomerOrganizationChatbot  from "../Container/Customer/Organization/chatbot1"
    ...
    return (
      <Router>
        <Routes>
          ...
          <Route path={`/customer/${customer}/organizations/:id/chatbot/`}
           element={<CustomerOrganizationChatbot />}
           /> 
